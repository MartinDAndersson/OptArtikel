...
OptSwitch is a Julia framework for solving optimal switching problems using machine learning techniques, particularly neural networks. The project focuses on modeling and optimizing dynamic decision-making processes where a system can switch between different modes of operation over time.
...
This project is authored by Benny, Martin and Marcus.